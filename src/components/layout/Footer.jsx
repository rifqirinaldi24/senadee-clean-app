      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <span className="text-sm text-white/80 hover:text-white cursor-pointer transition-colors">Tentang Kami</span>
              </li>
              <li>
                <span className="text-sm text-white/80 hover:text-white cursor-pointer transition-colors">Tim Redaksi</span>
              </li>
              <li>
                <span className="text-sm text-white/80 hover:text-white cursor-pointer transition-colors">Kebijakan Privasi</span>
              </li>
              <li>
                <span className="text-sm text-white/80 hover:text-white cursor-pointer transition-colors">Syarat & Ketentuan</span>
              </li>
            </ul>
          </div>
