export const PILLARS = [
  { id: 'lifestyle', name: 'Gaya Hidup', nameEn: 'Lifestyle', icon: '🌿', color: 'pillar-lifestyle', percentage: 10, description: 'Tren dan kebiasaan sehat sehari-hari' },
  { id: 'fitness', name: 'Kebugaran & Olahraga', nameEn: 'Fitness & Sports', icon: '🏃', color: 'pillar-fitness', percentage: 10, description: 'Aktivitas fisik dan olahraga untuk tubuh bugar' },
  { id: 'beauty', name: 'Kecantikan', nameEn: 'Beauty', icon: '✨', color: 'pillar-beauty', percentage: 10, description: 'Perawatan kulit, rambut, dan estetika medis' },
  { id: 'pregnancy', name: 'Kehamilan', nameEn: 'Pregnancy', icon: '🤰', color: 'pillar-pregnancy', percentage: 10, description: 'Kesehatan ibu hamil dan perkembangan janin' },
  { id: 'family', name: 'Keluarga', nameEn: 'Family', icon: '👨‍👩‍👧‍👦', color: 'pillar-family', percentage: 10, description: 'Kesehatan anak, parenting, dan keluarga' },
  { id: 'health', name: 'Kesehatan', nameEn: 'General Health', icon: '⚕️', color: 'pillar-health', percentage: 10, description: 'Informasi penyakit dan kondisi medis umum' },
  { id: 'elderly', name: 'Kesehatan Lansia', nameEn: 'Elderly Health', icon: '👴', color: 'pillar-elderly', percentage: 10, description: 'Perawatan geriatri dan usia lanjut' },
  { id: 'mental-health', name: 'Kesehatan Mental', nameEn: 'Mental Health', icon: '🧠', color: 'pillar-mental', percentage: 10, description: 'Kesejahteraan psikologis dan emosional' },
  { id: 'nutrition', name: 'Nutrisi & Diet', nameEn: 'Nutrition & Diet', icon: '🥗', color: 'pillar-nutrition', percentage: 10, description: 'Panduan gizi seimbang dan pola makan sehat' },
  { id: 'first-aid', name: 'Pertolongan Pertama', nameEn: 'First Aid', icon: '🚑', color: 'pillar-firstaid', percentage: 10, description: 'Tindakan medis darurat dan keselamatan' },
];
...
export const articles = [
  {
    ...
    title: 'Panduan Memenuhi Nutrisi Anak Berdasarkan Usia',
  ...
  },
  {
    ...
    title: 'Panduan MPASI Bayi 6 Bulan Pertama yang Sehat',
  ...
  },
  {
    ...
    title: '7 Olahraga Rumahan untuk Menjaga Kebugaran Ibu Bekerja',
  ...
  },
  {
    ...
    title: 'Jadwal Vaksinasi Anak 2026 untuk Imunisasi Wajib dan Tambahan',
  ...
  },
  {
    ...
    title: 'Cara Mengelola Screen Time Anak Sesuai Rekomendasi Usia',
  ...
  },
  {
    ...
    title: '5 Resep Smoothie Bowl untuk Sarapan Sehat Keluarga',
  ...
  },
  {
    ...
    title: 'Deteksi Gejala Diabetes Tipe 2 Sebelum Terlambat',
  ...
  },
  {
    ...
    title: '10 Pose Yoga untuk Pemula yang Dilakukan di Rumah',
